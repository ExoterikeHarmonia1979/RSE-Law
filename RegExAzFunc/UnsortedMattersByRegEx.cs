...
public class UnsortedMattersByRegEx
{
    ...
    private readonly ILogger<UnsortedMattersByRegEx> _logger;

    public UnsortedMattersByRegEx(ILogger<UnsortedMattersByRegEx> logger)
    {
        _logger = logger;
    }

    [Function("UnsortedMattersByRegEx")]
